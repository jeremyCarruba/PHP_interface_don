...
class DonationFeeTest extends TestCase
{
    ...
    public function testAmountCollectedAfterFeeFor100and10(){
        $donationFees = new DonationFee(100,10);
        $actual = $donationFees->getAmountCollectedAfterFee();
        $expected = 40;

        $this->assertEquals($expected, $actual);
    }

    public function testAmountCollectedAfterFeeFor200and20(){
        $donationFees = new DonationFee(200,20);
        $actual = $donationFees->getAmountCollectedAfterFee();
        $expected = 110;
